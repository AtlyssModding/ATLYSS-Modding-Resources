    ...
    foreach (ScriptableItem i in VanillaItems) {
        ...
        if (itemtype == typeof(ScriptableArmorDye) || itemtype == typeof(ScriptableStatusConsumable)) {
            ...
            if (itemtype == typeof(ScriptableWeapon)) {
                ...
                Lines.Add($"_weaponHoldClipIndex : {i3._weaponHoldClipIndex}");
                ...
                if (i3._weaponConditionSlot != null && i3._weaponConditionSlot._scriptableCondition) {
                    Lines.Add("_weaponConditionSlot : {");
                    Lines.Add($"    _scriptableCondition : {i3._weaponConditionSlot._scriptableCondition._conditionName} - ID: {i3._weaponConditionSlot._scriptableCondition._ID}");
                    Lines.Add($"    _chance : {i3._weaponConditionSlot._chance}");
                    Lines.Add($"    _bonusPower : {i3._weaponConditionSlot._bonusPower}");
                    Lines.Add($"    _bonusDuration : {i3._weaponConditionSlot._bonusDuration}");
                    Lines.Add("}");
                }
                if (i3._weaponConditionSlot == null || !i3._weaponConditionSlot._scriptableCondition) { Lines.Add("_weaponConditionSlot : None"); }
