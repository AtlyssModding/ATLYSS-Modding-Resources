    ...
    foreach (ScriptableItem i in VanillaItems) {
        ...
        if (itemtype == typeof(ScriptableArmorDye) || itemtype == typeof(ScriptableStatusConsumable)) {
            ...
            if (itemtype == typeof(ScriptableWeapon)) {
                ...
                Lines.Add("\n- ScriptableWeapon -");
                Lines.Add($"weaponType : {i3.weaponType._weaponTypeName}");
                if (i3._combatElement) {
                    Lines.Add($"_combatElement : {i3._combatElement._elementName}");
                }
                if (!i3._combatElement) {
                ...
                if (i3._weaponConditionSlot != null && i3._weaponConditionSlot._scriptableCondition) {
                    ...
                    Lines.Add($"    _scriptableCondition : {i3._weaponConditionSlot._scriptableCondition._conditionName}");
