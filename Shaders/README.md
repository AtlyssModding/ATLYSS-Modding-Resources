...
```
These shaders require `TerrainSplatmapCustom.cginc` to work. This is only required for the terrain, needing the material to be set to `_mat_TerrainTriPlanar.mat`. (Edited by WolfKann to increase layer compatibility)
```
