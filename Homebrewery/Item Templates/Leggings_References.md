...
```
- "belt_00"     (Used by: Slimek Leggings, Temrak Britches)
- "legCuffs_00" (Used by: Slimek Leggings, Journeyman Leggings, Dense Leggings, Sash Leggings, Warrior Leggings, Amberite Leggings, Reapsow Pants, Berserker Leggings, Magilord Boots, Executioner Legging)
- "legCuffs_01" (Used by: Lord Greaves, King Greaves)
