...
Download the whole repository using `<> Code` -> "Download ZIP" or download individual folders using [**Download Github directory**](https://download-directory.github.io/).
...
- [**Vanilla Changes**](/Vanaila%20Changes)
- [**Shaders**](/Shaders)
#
## External Resources
...
- `Mellodonix:` Wiki help. ([YouTube](https://www.youtube.com/channel/UCW1qQXqYp3aKW5S5y6nyGdg))
...
- `Zera:` MapLoader creator guide. ([**Github**](https://github.com/LefiloMandering) - [**Thunderstore**](https://thunderstore.io/c/atlyss/p/ZenFishes/))
- `WolfKann:` Emote Wheel creator guide. ([**Github**](https://github.com/WolfKann) - [**Thunderstore**](https://thunderstore.io/c/atlyss/p/WolfKann/))
- `WawaTofu:` AtlyssTools Google Drive. ([**Thunderstore**](https://thunderstore.io/c/atlyss/p/WawaTofu/))
- `Yuka_Tanga:` Kiseff games archive.
